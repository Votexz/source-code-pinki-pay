	...
	override public function create()
	{
		...
		switch(SONG.stage)
		{
			...
			case 'pinkie': 
			{
					...
					var bg:FlxSprite = new FlxSprite(-600, -203).loadGraphic(Paths.image('pinki/hohol', 'shared'));
		...
		if (dad.curCharacter == 'spooky' && curStep % 4 == 2)
		{
			...
			if (curSong == 'Smile')
			{
				switch (curStep){
					case 138:
					{
						dad.playAnim('howdy', true);
					}	
					case 163:
					{
						dad.playAnim('howyadoin', true);
					}
					case 255:
					{
					...
					case 571:
					{
						dad.playAnim('whatsup', true);
					}
					case 667:
					{
						dad.playAnim('hello', true);
					}
			}
		}
